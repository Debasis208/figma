...
function App() {
  ...
  return (
    <div className="App">
      <LandingPage
        data={CrystalData.data}
        scrollToNextSection={scrollToNextSection}
      />

      <div ref={nextSectionRef} className="filter_cards">
        <div className="filter_card_heading">
          <p>All Product</p> <span className="span_tag"></span>
        </div>
      ...
      <div
        ...
        style={{
          backgroundImage: `url(${firsttt}), linear-gradient(112.45deg, #8481FF 0%, #2EF1FD 48.5%, #0430A1 100%)`
        }}
      >
        <div className="last_section_container">
          <div className="last_left_section">
            ...
            <button className="last_buy_button">BUY NOW</button>
          </div>
